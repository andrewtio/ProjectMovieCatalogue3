...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate menu, ini akan menambahkan item ke action bar jika ada
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Mengontrol item action bar dengan klik disini. Action bar akan secara otomatis
        // menghandle klik pada Home/Up Button, sepanjang
        // anda bisa spesifikasikan aktifitas parent di AndroidManifest.xml
